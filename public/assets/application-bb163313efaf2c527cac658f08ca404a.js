...
$(document).on('click', '.panel-heading span.clickable', function(e){
    var <his = $(this);
    if(!<his.hasClass('panel-collapsed')) {
        <his.parents('.panel').find('.panel-body').slideUp();
        <his.addClass('panel-collapsed');
        <his.find('i').removeClass('glyphicon-chevron-up').addClass('glyphicon-chevron-down');
    } else {
        <his.parents('.panel').find('.panel-body').slideDown();
        <his.removeClass('panel-collapsed');
        <his.find('i').removeClass('glyphicon-chevron-down').addClass('glyphicon-chevron-up');
    }
});
